...
const ChartTooltipContent = React.forwardRef((
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border bg-white dark:bg-gray-950 px-2.5 py-1.5 text-xs shadow-xl text-gray-900 dark:text-gray-50",
        className
      )}>
